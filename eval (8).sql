...
(5, 14, 32, 'false', '2019-06-12 04:46:24'),
...
(13, 'Muhamad ', 'Khulqi', 'khulqimuhamad@gmail.com', '$2a$10$SDFRP3m2cj3a8H2b4OYl8O2UvoXAJhvDhq3brHlefgbVY2iYjc0Gu', '89694320475', '1997-09-07', '2019-10-08', 'IT-DEV', 1, 56, 'false', '2019-06-13 14:21:50'),
(14, 'Oka', 'Lanang ', 'okalanang13@gmail.com', '$2a$10$suDEXHFJpXZ/dNwtTpyK/u/QP25t.kb6xvf9DKwkW9tV8i2usiLZa', '89694320475', '1998-09-10', '2019-01-02', 'IT-DEV', 1, 57, 'false', '2019-06-12 04:00:17'),
...
--
ALTER TABLE `validation`
  ADD CONSTRAINT `valid_emp` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`id`);
COMMIT;
