...
import eval.eval.repositories.ForgetPasswordRepositories;
...
public class ForgetPasswordController {
    ...
    @Autowired
    private ForgetPasswordRepositories forgetPasswordRepositories;
    ...
    public String sendForgetPassword(String email) {
        ...
        ForgetPassword forgetPassword = new ForgetPassword(0, token, "false", new Date(), e);
        forgetPasswordRepositories.save(forgetPassword);
        return result;
    }
